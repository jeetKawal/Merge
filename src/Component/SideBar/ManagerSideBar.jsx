  ...
  <div className="container-fluid">
    ...
    <div className="main-menu flex-grow-1">
      <ul className="menu-list">
        <li>
          <a className="m-link" href="/managerdashboard">
            <svg
        ...
        <li className="menu-item">
          <a className="m-link" href="/managerleave">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={20}
              height={20}
        ...
        <li>
          <a className="m-link" href="managerattendance">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={20}
              height={20}
        ...
        <li>
          <a className="m-link" href="managerexpense">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={22}
              height={22}
