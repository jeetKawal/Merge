          ...
          <div className="col-12 ">
            <div className="mb-4">
              <div className="row-title justify-content-between mb-1">
                <h4 className="pt-2">Status</h4>
                <div>
                  <button
                    className="btn btn-primary py-1"
                    data-bs-toggle="offcanvas"
                    data-bs-target="#init_sep"
                  >
            ...
            >
              <div className="offcanvas-header">
                <h5 className="offcanvas-title">Initiate Separation</h5>
                <button
                  type="button"
              ...
              <div className="offcanvas-body">
                <div className="col-12 py-1">
                  <select
                    ...
                    id="selectId"
                    onchange="hideSection1()"
                  >
                    <option selected="">Type</option>
                    <option id="ShowSection1" value="Termination or Death">
                      Termination or Death
                    </option>
                    <option value="Retirement">Retirement</option>
                    <option value="Employee absconded">
                      Employee absconded
                    </option>
                    <option value="HR/Manager Initiated resignation">
                      HR/Manager Initiated resignation
                    </option>
                  </select>
                </div>
                <div className="" id="termination_death">
                    ...
                    <form className="row g-3">
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <fieldset>
                          ...
                          >
                            <option selected="" />
                            <option>Shubham Gill</option>
                            <option>Raunak Sharma</option>
                            <option>Shefali Jain</option>
                            <option>Priyam Luthra</option>
                          </select>
                        </fieldset>
                      </div>
                      <div className="col-lg-6 col-md-6 col-sm-6">
                      ...
                      <div className="col-lg-12 col-md-6 col-sm-6">
                        ...
                        <fieldset>
                          ...
                          >
                            ...
                            <option>Damaging company property</option>
                            <option>Stealing</option>
                          </select>
                        </fieldset>
                      </div>
                      <div className="col-lg-12 col-md-6">
                        <label className="form-label">Attach report</label>
                        <input
                          type="file"
                          className="form-control"
                ...
                <div className="" id="retirement">
                  <div className="col-12 mt-4">
                    <form className="row g-3">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <label className="form-label">Age at LWD</label>
                        <input
                          type="text"
                          className="form-control"
                          placeholder=""
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <label className="form-label">LWD as per policy</label>
                        <input
                          type="date"
                          className="form-control"
                          placeholder=""
                ...
                <div className="" id="abscond">
                  <div className="col-12 mt-4">
                    <form className="row g-3">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <label className="form-label">Last Present date</label>
                        <input
                          type="date"
                          className="form-control"
                          placeholder=""
                    ...
                    <form className="row g-3">
                      ...
                      <div className="col-lg-12 col-md-6 col-sm-6">
                        ...
                        <fieldset>
                          ...
                          >
                            <option selected="" />
                            <option>Excessive workload</option>
                            <option>Career growth</option>
                            <option>Better opportunity outside</option>
                            <option>Current job dissatisfaction</option>
                          </select>
                        </fieldset>
                      </div>
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <label className="form-label mb-3">
                          Discussed with manager earlier?
                        </label>
            ...
            >
              ...
              <div className="offcanvas-body text-center">
                <div>
                  <div className="rounded-circle bg-light col-12 text-center display-2 py-4">
